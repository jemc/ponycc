...
class ASTGen
  ...
  fun string(): String =>
    ...
    g.line("  end")
    g.line("fun val attach_val[A: Any val](a: A): AST")
    g.line("fun val attach_tag[A: Any tag](a: A): AST")
    g.line("fun val find_attached_val[A: Any val](): A?")
    g.line("fun val find_attached_tag[A: Any tag](): A?")
