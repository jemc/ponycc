  ...
  fun apply(g: ASTGen) =>
    ...
    for name in [
      ...
      g.def(name)
        ...
        .> has("cap",         "(Cap | None)")
        .> has("provides",    "(Provides | None)")
        .> has("members",     "(Members | None)")
        .> has("at",          "(At | None)")
        .> has("docs",        "(LitString | None)")
    end
    ...
    g.def("Lambda")
      ...
      .> has("type_params", "(TypeParams | None)")
      .> has("params",      "(Params | None)")
      .> has("captures",    "(LambdaCaptures | None)")
      .> has("return_type", "(TypePtr | None)")
      .> has("partial",     "(Question | None)")
      .> has("body",        "(RawExprSeq)")
      .> has("object_cap",  "(Cap | None | Question)")
    ...
    g.def("LambdaType")
      ...
      .> has("name",        "(Id | None)")
      .> has("type_params", "(TypeParams | None)")
      .> has("params",      "(TypePtrList | None)")
      .> has("return_type", "(TypePtr | None)")
      .> has("partial",     "(Question | None)")
      .> has("object_cap",  "(Cap | GenCap | None)")
      .> has("cap_mod",     "(CapMod | None)")
